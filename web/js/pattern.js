...
class PatternDB {
    ...
    addBlock3Patterns() {
        ...
        addBlock3(0,0,1,2,1,1,2,0,0, 0,0,0);  // ⬅️ 新增：右紧邻[6]被封
        addBlock3(0,0,1,2,1,1,2,0,2, 0,0,0);  // ⬅️ 新增：右紧邻[6]+远位[8]
        addBlock3(0,0,1,2,1,1,2,2,0, 0,0,0);  // ⬅️ 新增：双封[6,7]
        addBlock3(0,0,1,2,1,1,2,2,2, 0,0,0);  // 三封[6,7,8]
        ...
        addBlock3(2,0,1,2,1,1,2,0,0, 0,0,0);  // ⬅️ 新增：左+右紧邻
        addBlock3(2,0,1,2,1,1,2,0,2, 0,0,0);
        addBlock3(2,0,1,2,1,1,2,2,0, 0,0,0);  // ⬅️ 新增：左+双右
        ...
        addBlock3(0,0,1,1,2,1,2,0,0, 0,0,0);  // ⬅️ 新增：右紧邻[6]被封
        addBlock3(0,0,1,1,2,1,2,0,2, 0,0,0);
        addBlock3(0,0,1,1,2,1,2,2,0, 0,0,0);  // ⬅️ 新增：双封[6,7]
        ...
        addBlock3(2,0,1,1,2,1,2,0,0, 0,0,0);  // ⬅️ 新增：左+右紧邻
        addBlock3(2,0,1,1,2,1,2,0,2, 0,0,0);
        addBlock3(2,0,1,1,2,1,2,2,0, 0,0,0);  // ⬅️ 新增：左+双右
    ...
    addBlock2Patterns() {
        ...
        addBlock2(0,0,0,1,2,1,2,0,0, 0,0,0);  // ⬅️ 新增：右紧邻[6]被封
        addBlock2(0,0,0,1,2,1,2,0,2, 0,0,0);
        addBlock2(0,0,0,1,2,1,2,2,0, 0,0,0);  // ⬅️ 新增：双封[6,7]
        ...
        addBlock2(2,0,0,1,2,1,2,0,0, 0,0,0);  // ⬅️ 新增：左+右紧邻
        addBlock2(2,0,0,1,2,1,2,0,2, 0,0,0);
        addBlock2(2,0,0,1,2,1,2,2,0, 0,0,0);  // ⬅️ 新增：左+双右
